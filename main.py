...
async def start_handler(_, event: Message):
	await event.reply_photo("https://telegra.ph/file/19eeb26fa2ce58765917a.jpg",
					...
					[InlineKeyboardButton('❤ Donation Link', url='https://t.me/oxmoviessbackup/3')],
					[InlineKeyboardButton("Updates 𝙲𝚑𝚊𝚗𝚗𝚊𝚕", url="https://t.me/oxmoviessbackup")],
...
async def inline_handlers(_, event: Message):
    if event.text == '/start':
        return
    answers = f'**📂 Searching Text ➠ {event.text} \n\n➠ Movie Name Sehi Se Likho.🗓️\n➠ Join @oxmoviessbackup▰▱▰▱▰▱▰▱▰▱▰▱▰▱\n\n**'
